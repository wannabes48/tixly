    ...
    <form onSubmit={handleSubmit} className="w-full">
      ...
      {error && (
        <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg mb-6 text-sm flex flex-col gap-3">
          <p>{error}</p>
          <a href="https://wa.me/16176740104" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#128C7E] text-white font-bold py-2 px-4 rounded-lg transition-colors w-fit text-xs">
