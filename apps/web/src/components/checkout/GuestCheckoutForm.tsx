  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input 
            ...
            className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 outline-none focus:border-brand-midblue disabled:opacity-50" 
          />
        </div>
        <div>
      ...
      <button 
        ...
        className="w-full bg-brand-orange hover:bg-orange-600 disabled:bg-orange-400 text-white font-bold py-3.5 rounded-xl transition-colors mt-4 flex items-center justify-center gap-2 shadow-md hover:-translate-y-0.5"
      >
        {isTransitioning ? (
