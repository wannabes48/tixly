...
const paymentMethods = [
  { name: 'Visa', src: '/5968397.png' },
  { name: 'Mastercard', src: '/MasterCard_Logo.svg.png' },
  { name: 'Amex', src: '/American_Express_logo_(2018).svg' },
  { name: 'PayPal', src: '/PayPal-Logo-History-1.png' },
  { name: 'Apple Pay', src: '/apple-pay-og.jpg' },
  { name: 'Google Pay', src: '/unnamed.jpg' },
];
        ...
        <div className="pt-6 border-t border-gray-100">
          ...
          <div className="flex flex-wrap items-center gap-2 mb-4">
            {paymentMethods.map((method) => (
              <div
                key={method.name}
                className="inline-flex items-center justify-center h-8 bg-white border border-gray-200 rounded px-2 overflow-hidden"
                title={method.name}
              >
