      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-soft border border-gray-100">
          ...
          <div className="text-base text-gray-600 space-y-6">
            <h2 className="text-2xl font-black text-[#1A3C5E] mt-10 mb-4">1. Information We Collect</h2>
            <p>
              At Tixly, we collect information to provide a seamless marketplace experience. This includes:
            </p>
            <ul className="list-disc pl-5 space-y-2 text-base">
              <li><strong className="font-bold text-[#1A3C5E]">Personal Data:</strong> Name, email address, billing/shipping address, and phone number when you create an account or checkout.</li>
              <li><strong className="font-bold text-[#1A3C5E]">Payment Data:</strong> Handled securely via our PCI-compliant partners (e.g., Stripe). We do not store full credit card details.</li>
              <li><strong className="font-bold text-[#1A3C5E]">Usage Data:</strong> Device information, IP address, and interaction data via cookies to improve site performance.</li>
            </ul>

            <h2 className="text-2xl font-black text-[#1A3C5E] mt-10 mb-4">2. How We Use Your Data</h2>
            <p>
            ...
            <h2 className="text-2xl font-black text-[#1A3C5E] mt-10 mb-4">3. Information Sharing</h2>
            <p>
              We only share your information with trusted third parties necessary to process your transaction (e.g., payment gateways, ticket sellers for transfer purposes). We <strong className="font-bold text-[#1A3C5E]">never</strong> sell your personal data to advertisers.
            </p>

            <h2 className="text-2xl font-black text-[#1A3C5E] mt-10 mb-4">4. GDPR & CCPA Compliance</h2>
            <p>
            ...
            <h2 className="text-2xl font-black text-[#1A3C5E] mt-10 mb-4">5. Cookies and Tracking</h2>
            <p>
            ...
            <h2 className="text-2xl font-black text-[#1A3C5E] mt-10 mb-4">6. Data Security</h2>
            <p>
