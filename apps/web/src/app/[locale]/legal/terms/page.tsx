      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-soft border border-gray-100">
          <div className="mb-10 text-center">
            <h1 className="text-3xl md:text-5xl font-black text-brand-navy tracking-tight mb-4">Terms & Conditions</h1>
            <p className="text-gray-500">Last Updated: May 31, 2026</p>
          </div>

          <div className="text-base text-gray-600 space-y-6">
            <h2 className="text-2xl font-black text-[#1A3C5E] mt-10 mb-4">1. Introduction</h2>
            <p>
            ...
            <h2 className="text-2xl font-black text-[#1A3C5E] mt-10 mb-4">2. Tixly as a Marketplace</h2>
            <p>
              Tixly operates as an independent ticket marketplace. We are <strong className="font-bold text-[#1A3C5E]">not</strong> officially affiliated with FIFA, the organizing committees, or any official federations. We act as an intermediary connecting ticket buyers with independent sellers. Prices are set by sellers and may be above or below the original "face value."
            </p>

            <h2 className="text-2xl font-black text-[#1A3C5E] mt-10 mb-4">3. Buyer Guarantee</h2>
            <p>
            ...
            <h2 className="text-2xl font-black text-[#1A3C5E] mt-10 mb-4">4. Purchasing Tickets</h2>
            <p>
            ...
            <h2 className="text-2xl font-black text-[#1A3C5E] mt-10 mb-4">5. Event Cancellations and Postponements</h2>
            <p>
            ...
            <h2 className="text-2xl font-black text-[#1A3C5E] mt-10 mb-4">6. Liability</h2>
            <p>
            ...
            <h2 className="text-2xl font-black text-[#1A3C5E] mt-10 mb-4">7. Governing Law</h2>
            <p>
