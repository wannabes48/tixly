...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var getTeam, getStadium, matchUpdates, _i, matchUpdates_1, update, homeTeam, awayTeam, stadium, matchToUpdate, listingsToCreate, _a, listingsToCreate_1, listing;
        var _this = this;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    console.log("Updating Matches 74, 77, 78, 86, 88...");
                    ...
                    matchUpdates = [
                        { num: 74, home: "germany", away: "paraguay", citySearch: "Boston" },
                        { num: 77, home: "france", away: "sweden", citySearch: "New York" },
                        { num: 78, home: "cote-divoire", away: "norway", citySearch: "Dallas" },
                        { num: 86, home: "argentina", away: "cape-verde", citySearch: "Miami" },
                        { num: 88, home: "australia", away: "egypt", citySearch: "Dallas" }
                    ];
